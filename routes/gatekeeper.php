...
Route::middleware(['auth', 'verified', 'active.user', 'active.mitra', 'permission:access.gatekeeper'])->prefix('gatekeeper')->name('gatekeeper.')->group(function () {
    Route::get('/dashboard', [EventTicketController::class, 'index'])->name('dashboard');
    Route::get('/{mitra}/dashboard', [EventTicketController::class, 'index'])->name('context.dashboard');
