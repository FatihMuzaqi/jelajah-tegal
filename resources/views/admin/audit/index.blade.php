                    ...
                    <tbody>
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td data-label="Target Model">
                                    {{ $log->auditable_type ? class_basename($log->auditable_type) : '-' }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4">
                                    <x-empty-state title="Belum ada audit log"
                                        description="Catatan audit akan tampil di sini." compact />
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
