            ...
            <table class="lokantara-table">
                ...
                <tbody>
                    @forelse($users as $u)
                        <tr>
                            ...
                            <td data-label="Status">
                                <span class="status-badge {{ $u->status === 'active' ? 'status-success' : 'status-warning' }}">
                                    {{ strtoupper($u->status) }}
                                </span>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4">
                                <x-empty-state title="Belum ada pengguna" description="Tidak ada data pengguna." compact />
                            </td>
                        </tr>
                    @endforelse
                </tbody>
