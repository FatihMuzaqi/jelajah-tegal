                    ...
                    @forelse ($accommodation->reviews as $review)
                        <div class="p-3 mb-3 rounded-3" style="background: var(--lokantara-background); border: 1px solid var(--lokantara-border);">
                            ...
                            <div class="mt-2.5 pt-2 d-flex align-items-center justify-content-between">
                                <button type="button" class="btn btn-sm btn-link text-decoration-none p-0 text-primary fw-semibold" style="font-size: 12px;" data-bs-toggle="collapse" data-bs-target="#replyBox-acc-{{ $review->id }}" aria-expanded="false">
                                ...
                                @auth
                                    <form method="POST" action="{{ route('public.reviews.replies.store', $review->id) }}" class="p-2.5 rounded-3 bg-white border">
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            <button type="button" class="btn btn-sm btn-light py-1 px-2.5 border" style="font-size: 11.5px;" data-bs-toggle="collapse" data-bs-target="#replyBox-acc-{{ $review->id }}">Batal</button>
