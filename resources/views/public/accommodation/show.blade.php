            ...
            <div class="col-lg-8">
                ...
                <div class="hotel-card">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h2 class="hotel-card-title mb-0"><span class="title-icon"><i class="fa-solid fa-comments text-info"></i></span> Ulasan & Pengalaman Tamu</h2>
                        <span class="badge bg-light text-muted border px-2.5 py-1.5 fs-8">{{ $accommodation->reviews->count() }} Ulasan</span>
                    </div>
                    ...
                    <h4 class="fs-6 fw-bold mb-3 text-dark d-flex align-items-center gap-2">
                        ...
                        <span>Semua Ulasan Tamu ({{ $accommodation->reviews->count() }})</span>
                    </h4>
                    ...
                    @forelse ($accommodation->reviews as $review)
                        <div class="p-3 mb-3 rounded-4 shadow-sm bg-white border" style="transition: all 0.2s ease;">
                                ...
                                <div class="d-flex align-items-center gap-2.5">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-1.5 flex-wrap">
                                            <strong class="fs-7 text-dark">{{ $review->user?->name ?? 'Tamu Penginapan' }}</strong>
                                        </div>
                            ...
                            <div class="mt-2.5 pt-2 d-flex align-items-center justify-content-between">
                                <button type="button" class="btn btn-sm btn-link text-decoration-none p-0 text-primary fw-semibold d-inline-flex align-items-center gap-1" style="font-size: 12px;" data-bs-toggle="collapse" data-bs-target="#replyBox-acc-{{ $review->id }}" aria-expanded="false">
                            ...
                            <div class="collapse mt-2.5" id="replyBox-acc-{{ $review->id }}">
                                @auth
                                    <form method="POST" action="{{ route('public.reviews.replies.store', $review->id) }}" class="p-3 rounded-3 bg-white border shadow-sm">
                                        ...
                                        <div class="mb-2">
                                            <textarea name="body" class="form-control form-control-sm" rows="2" placeholder="Tulis balasan atau tanggapan Anda..." required style="font-size: 12.5px; border-radius: 8px;"></textarea>
                                        </div>
                                        <div class="d-flex justify-content-end gap-2">
                                            <button type="button" class="btn btn-sm btn-light py-1 px-3 border rounded-pill" style="font-size: 11.5px;" data-bs-toggle="collapse" data-bs-target="#replyBox-acc-{{ $review->id }}">Batal</button>
