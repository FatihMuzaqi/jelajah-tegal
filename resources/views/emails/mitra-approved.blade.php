...
<head>
    ...
    <title>Pendaftaran Mitra Disetujui — Jelajah Tegal</title>
    <style>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-card" style="max-width: 600px; width: 100%; margin: 0 auto; background-color: #ffffff; border-radius: 18px; overflow: hidden; box-shadow: 0 8px 24px rgba(15, 23, 42, 0.07); border: 1px solid #e2e8f0;">
                    ...
                    <tr>
                        <td class="body-cell" style="padding: 32px 32px 24px; background-color: #ffffff;">
                            ...
                            <!-- Status Badge -->
                            <div style="display: inline-block; background-color: #ecfdf5; border: 1px solid #a7f3d0; border-radius: 99px; padding: 4px 14px; margin-bottom: 16px;">
                                <span style="font-size: 11px; font-weight: 700; color: #047857; text-transform: uppercase; letter-spacing: 0.04em;">
                                    Status: Akun Kemitraan Disetujui &amp; Aktif
                                </span>
                            </div>

                            <h1 style="margin: 0 0 14px; font-size: 21px; font-weight: 800; color: #0f172a; line-height: 1.35; letter-spacing: -0.02em;">
                                Selamat! Pendaftaran Mitra Anda Telah Disetujui
                            </h1>
                            ...
                            <p style="margin: 0 0 18px; font-size: 14px; color: #475569; line-height: 1.6;">
                                Kami dengan bangga memberitahukan bahwa permohonan kemitraan untuk <strong>{{ $mitra->display_name }}</strong> telah melalui proses verifikasi berkas oleh Tim Kurasi Dinas Pariwisata dan Administrator <strong>Jelajah Tegal</strong>. Akun bisnis Anda saat ini telah <strong>resmi aktif</strong> di sistem.
                            </p>
                                    ...
                                    <td style="padding: 16px 18px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px 0; font-size: 13.5px; color: #0f172a; font-weight: 600; vertical-align: top;">{{ $mitra->region?->name ?? 'Kabupaten / Kota Tegal' }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; font-size: 12.5px; color: #64748b; font-weight: 600; vertical-align: top;">Email Akun:</td>
                                                <td style="padding: 5px 0; font-size: 13.5px; color: #0f172a; font-weight: 700; word-break: break-all; vertical-align: top;">{{ $recipientEmail }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; font-size: 12.5px; color: #64748b; font-weight: 600; vertical-align: top;">Status Verifikasi:</td>
                                                <td style="padding: 5px 0; font-size: 13.5px; color: #059669; font-weight: 700; vertical-align: top;">
                                                    Terverifikasi Sah {{ $mitra->is_verified ? '(Badge Resmi Aktif)' : '' }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            @if(!empty($adminNotes))
                                <div style="background-color: #eff6ff; border-left: 4px solid #3b82f6; border-radius: 8px; padding: 14px 16px; margin-bottom: 20px;">
                                    <strong style="font-size: 12.5px; color: #1e40af; display: block; margin-bottom: 4px;">Catatan Khusus Administrator:</strong>
                                    <p style="margin: 0; font-size: 13px; color: #1e3a8a; line-height: 1.5;">{{ $adminNotes }}</p>
                                </div>
                            @endif

                            <p style="margin: 0 0 16px; font-size: 14px; color: #475569; line-height: 1.6;">
                                Silakan klik tombol di bawah ini untuk <strong>memverifikasi email dan langsung masuk secara otomatis</strong> ke Dashboard Portal Mitra Jelajah Tegal Anda:
                            </p>

                            <!-- CTA Button (Auto Login & Verify) -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 12px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $autoLoginUrl }}" target="_blank" class="cta-btn-link" style="display: inline-block; min-width: 280px; max-width: 100%; box-sizing: border-box; background: linear-gradient(135deg, #059669 0%, #047857 100%); color: #ffffff !important; font-size: 14.5px; font-weight: 700; text-decoration: none; padding: 15px 28px; border-radius: 10px; box-shadow: 0 4px 14px rgba(5, 150, 105, 0.35); text-transform: uppercase; letter-spacing: 0.03em; text-align: center;">
                                            Verifikasi &amp; Masuk ke Portal Mitra &rarr;
                                        </a>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin: 0 0 22px; font-size: 12px; color: #64748b; text-align: center; line-height: 1.5;">
                                Tautan ini aman dan khusus untuk akun Anda. Anda dapat langsung masuk ke dashboard tanpa perlu kirim ulang verifikasi email atau memasukkan kata sandi lagi.
                            </p>

                            <div style="background-color: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 10px; padding: 14px 16px; margin-bottom: 18px;">
                                <strong style="font-size: 12.5px; color: #166534; display: block; margin-bottom: 4px;">Panduan Langkah Pertama:</strong>
                                <ul style="margin: 0; padding-left: 18px; font-size: 12.5px; color: #15803d; line-height: 1.55;">
                                    <li>Periksa kelengkapan profil usaha dan unggah banner toko Anda.</li>
                                    <li>Tambahkan tiket wisata, menu kuliner, tipe kamar, atau armada rental.</li>
                                    <li>Bagikan tautan profil bisnis Jelajah Tegal Anda ke media sosial.</li>
                                </ul>
                            </div>
                    ...
                    <tr>
                        <td class="footer-cell" style="padding: 24px 32px; background-color: #f8fafc; border-top: 1px solid #e2e8f0; text-align: center; font-size: 12px; color: #64748b; line-height: 1.6;">
                            ...
                            <p style="margin: 0 0 8px;">Surel resmi ini dikirimkan otomatis oleh sistem Jelajah Tegal terkait status pendaftaran kemitraan Anda.</p>
