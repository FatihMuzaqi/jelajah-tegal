...
@section('page-description', 'Pindai kode QR dari layar smartphone pengunjung menggunakan kamera atau masukkan token secara manual.')
    ...
    <div class="col-lg-7">
        <div class="scanner-card">
            ...
            <div class="d-flex flex-wrap gap-2">
                <button type="button" id="start-scanner-btn" class="btn btn-lokantara fw-bold px-4" onclick="startScanner()">
                    📷 Aktifkan Kamera Scanner
                </button>
                <button type="button" id="stop-scanner-btn" class="btn btn-outline-danger fw-bold px-4" style="display: none;" onclick="stopScanner()">
                    ⏹️ Matikan Kamera
                </button>
            </div>
        ...
        <div class="scanner-card">
            ...
            <form id="validate-ticket-form" method="POST" action="{{ route('gatekeeper.tickets.validate') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="ticket-token-input" class="form-control" name="token" placeholder="Tempel atau ketik token tiket di sini..." required autofocus>
                </div>

                <div class="mb-3">
                    <label class="form-label text-muted" style="font-size: 12px;">Referensi Perangkat / Pos Loket (Opsional)</label>
                    <input class="form-control form-control-sm" name="device_reference" placeholder="Cth: Pintu Utama Barat / Gerbang 1">
                </div>
            ...
            <div class="p-3 rounded" style="background: var(--lokantara-background); border: 1px solid var(--lokantara-border); font-size: 12px;">
...
function startScanner() {
    ...
    html5QrCode.start(
        ...
        feedback.innerHTML = 'Gagal mengakses kamera. Pastikan Anda telah memberikan izin kamera pada browser atau gunakan input manual.';
