        ...
        <div class="alert alert-warning border-0 rounded-4 shadow-sm mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="small text-muted mb-0">Dokumen legalitas bisnis Anda belum diverifikasi oleh Admin. Silakan lengkapi KYC untuk dapat menambahkan data {{ strtolower($title) }} baru.</p>
                </div>
            </div>
