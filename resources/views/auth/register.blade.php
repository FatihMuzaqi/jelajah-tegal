...
@section('title', 'Daftar Akun — Jelajah Tegal')
@section('meta-description', 'Buat akun Jelajah Tegal baru untuk menikmati pemesanan tiket wisata, penginapan, reservasi kuliner, dan event lokal.')
        ...
        <div class="auth-card-grid">
            ...
            <div class="auth-visual-side">
                ...
                <div class="auth-hero-center">
                    <h1 class="auth-hero-title">
                        Bergabung & <span>Jelajahi Wisata</span>
                    </h1>
                    <p class="auth-hero-desc">
                        Buat akun gratis untuk merancang liburan impian dengan AI, memesan tiket destinasi, dan menikmati pengalaman lokal terbaik.
                    </p>
                </div>
            ...
            <div class="auth-form-side">
                ...
                <div class="auth-header">
                    ...
                    <p>Lengkapi informasi berikut untuk memulai.</p>
                </div>
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            <input id="name" name="name" type="text"
                                ...
                                value="{{ old('name') }}" placeholder="Contoh: Ahmad Fadilah" required autofocus
                                autocomplete="name">
                        </div>
                    </div>
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            <input id="password" name="password" type="password"
                                ...
                                placeholder="Buat kata sandi akun" required autocomplete="new-password">
                        </div>
                    </div>
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password"
                                class="form-control-custom" placeholder="Ulangi kata sandi di atas" required
