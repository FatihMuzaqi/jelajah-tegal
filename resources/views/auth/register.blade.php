            ...
            <div class="auth-card-grid">
                ...
                <div class="auth-visual-side">
                    <div>
                        ...
                        <h1 class="auth-hero-title">Bergabung dengan Ekosistem Jelajah Tegal</h1>
                        <p class="auth-hero-desc">Dapatkan akses penuh ke layanan wisata unggulan, penginapan nyaman, tempat
                            kuliner khas, dan acara menarik di daerah Anda.</p>
                        ...
                        <div class="form-input-group">
                            ...
                            <div class="form-input-wrapper">
                                ...
                                <input id="password" name="password" type="password"
                                    ...
                                    placeholder="Buat kata sandi aman" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="form-input-group">
                            ...
                            <div class="form-input-wrapper">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password"
                                    class="form-control-custom" placeholder="Ketik ulang kata sandi" required
