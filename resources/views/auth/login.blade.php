...
@section('meta-description', 'Masuk ke portal Lokantara untuk mengelola layanan wisata, akomodasi, kuliner, event, dan transaksi lokal.')
        ...
        <div class="auth-card-grid">
            ...
            <div class="auth-visual-side">
                <div>
                    ...
                    <h1 class="auth-hero-title">Ekosistem Monolit Wisata & Potensi Lokal</h1>
                    <p class="auth-hero-desc">Satu platform terintegrasi untuk destinasi wisata, akomodasi, kuliner, acara, dan rental lokal terverifikasi.</p>
                ...
                <div class="auth-visual-footer">
                    ...
                    <span class="badge bg-white bg-opacity-10 text-white rounded-pill px-3 py-1">100% Real Database</span>
                </div>
            </div>
            ...
            <div class="auth-form-side">
                ...
                <form method="POST" action="{{ route('login') }}" id="loginForm">
                    ...
                    <div class="form-input-group">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            >
                            <button type="button" class="password-toggle-btn" id="togglePasswordBtn" onclick="togglePasswordVisibility()" aria-label="Tampilkan atau sembunyikan kata sandi">
                ...
                <details class="testing-hints-box">
                    ...
                    <div class="testing-hints-grid">
                        <button type="button" class="hint-badge text-start btn border text-truncate" onclick="fillCredentials('admin@example.test', 'password')">
                            <strong>Admin</strong><br><small>admin@example.test</small>
                        </button>
                        <button type="button" class="hint-badge text-start btn border text-truncate" onclick="fillCredentials('owner@example.test', 'password')">
                            <strong>Mitra Owner</strong><br><small>owner@example.test</small>
                        </button>
                        <button type="button" class="hint-badge text-start btn border text-truncate" onclick="fillCredentials('consumer@example.test', 'password')">
